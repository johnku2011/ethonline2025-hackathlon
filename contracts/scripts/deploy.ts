...
async function main() {
  ...
  const pyusdTokenAddress = process.env.PYUSD_TOKEN_ADDRESS || "0x0000000000000000000000000000000000000000";
  ...
  console.log(`npx hardhat verify --network arbitrumSepolia ${subscription.address} ${pyusdTokenAddress} ${feeCollectorAddress}`);
}
